                        ...
                        <div class="row">
                            ...
                            <div class="col text-end">
                                <h4 class="card-title">
                                    ...
                                    <a href="ProductoServlet?accion=verReporte" class="btn btn-outline-warning" target="_blank">Reporte General</a>                                    
                                </h4>
                            </div>
                    ...
                    <table class ="table table-striped">
                        ...
                        <c:forEach var="dto" items="${listaDeProductos}" >
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <a href="ProductoServlet?accion=ver&id=<c:out value="${dto.entidad.idProducto}"/>" class="btn btn-outline-warning"><c:out value="${dto.entidad.idProducto}"/></a>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <a href="ProductoServlet?accion=actualizar&id=<c:out value="${dto.entidad.idProducto}"/>" class="btn btn-outline-warning">Actualizar</a>
                                    </td> 
                                    <td>
                                        <a href="ProductoServlet?accion=reporteIndividual&id=<c:out value="${dto.entidad.idProducto}"/>" class="btn btn-outline-info" target="_blank">Reporte</a>
                                    </td>
                                </tr>
